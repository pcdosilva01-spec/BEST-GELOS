...
const floatingPositions = [
  { left: 12.5, top: 18.3, delay: 0.2, size: 8 },
  { left: 78.2, top: 8.7, delay: 0.8, size: 6 },
  { left: 23.1, top: 65.4, delay: 1.1, size: 10 },
  { left: 85.6, top: 42.9, delay: 0.5, size: 7 },
  { left: 5.8, top: 33.7, delay: 1.4, size: 9 },
  { left: 92.3, top: 71.2, delay: 0.3, size: 5 },
  { left: 34.7, top: 15.6, delay: 1.7, size: 11 },
  { left: 67.9, top: 58.4, delay: 0.9, size: 6 },
  { left: 41.2, top: 82.1, delay: 1.3, size: 8 },
  { left: 18.6, top: 49.8, delay: 0.6, size: 7 },
  { left: 73.4, top: 24.5, delay: 1.0, size: 9 },
  { left: 56.8, top: 91.3, delay: 1.5, size: 5 },
];
...
export default function HomePage() {
  ...
  return (
    <>
      {/* Skip Link */}
      <a href="#main-content" className="skip-link sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-50 px-4 py-2 bg-primary text-primary-foreground rounded-lg">
        Pular para o conteúdo principal
      </a>

      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-frost-900/80 backdrop-blur-xl border-b border-ice-200/50 dark:border-ice-800/50">
        <nav className="container-custom" aria-label="Navegação principal">
          <div className="flex h-16 sm:h-18 items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-2" aria-label="Best Gelo - Página inicial">
              <div className="relative">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-ice flex items-center justify-center shadow-[var(--shadow-ice)]">
                  <Snowflake className="w-6 h-6 sm:w-7 sm:h-7 text-white" aria-hidden="true" />
                </div>
                {/* Polar bear accent - subtle polar shape */}
                <div className="absolute -bottom-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-accent rounded-full border-2 border-white dark:border-frost-900" aria-hidden="true" />
              </div>
              <span className="heading-brand text-xl sm:text-2xl text-frost-900 dark:text-white hidden sm:block">
                Best Gelo
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-body-sm font-medium text-frost-600 dark:text-frost-400 hover:text-primary dark:hover:text-ice-300 transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-primary after:transition-all hover:after:w-full"
                >
                  {link.label}
                </Link>
              ))}
          ...
          >
            <div className="py-4 space-y-2 border-t border-ice-200/50 dark:border-ice-800/50">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block px-4 py-2 text-body font-medium text-frost-600 dark:text-frost-400 hover:text-primary dark:hover:text-ice-300 hover:bg-ice-50 dark:hover:bg-ice-900/30 rounded-lg"
                  onClick={closeCart}
                >
                  {link.label}
                </Link>
              ))}
              <div className="px-4 pt-4 space-y-2 border-t border-ice-200/50 dark:border-ice-800/50">
      ...
      <main id="main-content">
        ...
        <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-ice-dark">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
            <div className="ice-crystal-xl top-1/4 left-1/4 rotate-12 animate-drift" style={{ animationDelay: '0s' }} />
            <div className="ice-crystal-lg top-1/3 right-1/6 -rotate-6 animate-drift" style={{ animationDelay: '-5s' }} />
            <div className="ice-crystal-md bottom-1/3 left-1/5 rotate-45 animate-drift" style={{ animationDelay: '-10s' }} />
            <div className="ice-crystal-sm bottom-1/4 right-1/4 -rotate-12 animate-drift" style={{ animationDelay: '-15s' }} />
            <div className="ice-crystal-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-30 animate-float" style={{ animationDuration: '8s' }} />
          </div>
          ...
          <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
            {floatingPositions.map((pos, i) => (
              <motion.div
                key={i}
                className="absolute rounded-xl bg-gradient-to-br from-white/20 to-white/5 border border-white/10"
                style={{
                  left: `${pos.left}%`,
                  top: `${pos.top}%`,
                  width: pos.size,
          ...
          <div className="relative container-custom py-20 lg:py-32">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full ice-glass border border-ice-300/50 dark:border-ice-700/50 text-frost-900 dark:text-ice-100 text-sm font-medium mb-8"
              >
              ...
              <motion.h1
                ...
                className="heading-display text-5xl sm:text-6xl lg:text-7xl text-white mb-8 text-balance leading-[1.1]"
              >
                Gelo de{' '}
                <span className="bg-gradient-to-r from-ice-200 via-white to-cyan-200 bg-clip-text text-transparent">
                  Qualidade
                </span>{' '}
                para seu{' '}
                <span className="bg-gradient-to-r from-ice-200 via-white to-cyan-200 bg-clip-text text-transparent">
              ...
              >
                <Button size="xl" asChild className="w-full sm:w-auto btn-primary">
                  <Link href="/pedido/novo">
              ...
              >
                {stats.map((stat, i) => (
                  <div key={stat.label} className="text-center">
                    <div className="heading-brand text-3xl sm:text-4xl lg:text-5xl text-white mb-1">
                      {stat.value}
                    </div>
        ...
        {/* Products Section */}
        <section id="produtos" className="section-padding bg-frost-50 dark:bg-frost-900/50 relative">
          <div className="absolute inset-0 bg-mesh-frost" aria-hidden="true" />
          <div className="container-custom relative">
            ...
            >
              ...
              <p className="text-body text-lg max-w-2xl mx-auto text-frost-600 dark:text-frost-400">
              ...
              {products.map((product, index) => (
                ...
                >
                  <Link href={`/produtos/${product.id}`} className="block">
                    <Card variant="interactive" className="h-full overflow-hidden card-product">
                      {/* Product Image */}
                      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-ice-100 to-ice-200 dark:from-ice-900/30 dark:to-ice-800/30">
                        <div className="absolute inset-0 flex items-center justify-center">
                          <Snowflake className="w-16 h-16 text-ice-300 dark:text-ice-700" aria-hidden="true" />
                        </div>
                        ...
                        {product.featured && (
                          <span className="absolute top-3 left-3 badge-accent z-10">Mais Vendido</span>
                        )}
                        <div className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-2 group-hover:translate-y-0">
                          <Button variant="ghost" size="icon" className="ice-glass text-frost-900 dark:text-ice-100">
                      ...
                      <CardContent className="p-5">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-xs font-medium text-primary bg-ice-100 dark:bg-ice-900/30 px-2 py-1 rounded-full">
                        ...
                        <h3 className="heading-card text-frost-900 dark:text-white text-lg mb-2 group-hover:text-primary transition-colors">
                          {product.name}
                        </h3>
                        <p className="text-body-sm text-frost-500 dark:text-frost-400 mb-4 line-clamp-2">{product.description}</p>
                        <div className="flex items-center justify-between">
                          <span className="heading-brand text-2xl text-primary">
        ...
        <section id="diferenciais" className="section-padding bg-white dark:bg-frost-900 relative">
          <div className="absolute inset-0 bg-mesh-frost" aria-hidden="true" />
          <div className="container-custom relative">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              ...
              {differentiators.map((diff, index) => (
                ...
                >
                  <div className="card-feature h-full relative overflow-hidden">
                    ...
                    <div className="frost-corner-tl" aria-hidden="true" />
                    <div className="frost-corner-tr" aria-hidden="true" />
                    <div className="frost-corner-bl" aria-hidden="true" />
                    <div className="frost-corner-br" aria-hidden="true" />
                    ...
                    <div className="relative mb-4">
                      ...
                      <div className="absolute -top-2 -right-2 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center shadow-[var(--shadow-ice)]">
                        <CheckCircle className="w-4 h-4 text-white" aria-hidden="true" />
                      </div>
                    </div>
                    <h3 className="heading-card text-frost-900 dark:text-white text-xl mb-3">{diff.title}</h3>
                    <p className="text-body text-frost-600 dark:text-frost-400">{diff.description}</p>
                  </div>
                </motion.article>
              ))}
            </div>
        ...
        {/* Process Section */}
        <section id="processo" className="section-padding bg-gradient-frost dark:bg-frost-900/50 relative">
          <div className="absolute inset-0 bg-mesh-ice" aria-hidden="true" />
          <div className="container-custom relative">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            <div className="relative">
              {/* Timeline Line */}
              <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-ice-300 via-ice-500 to-cyan-400 -translate-x-1/2" />
                  ...
                  >
                    <div className={`w-full lg:w-5/12 ${item.side === 'right' ? 'lg:text-right' : ''}`}>
                      <div className="flex items-center gap-3 lg:justify-end mb-4">
                        <span className="heading-brand text-3xl text-ice-200 dark:text-ice-700">{item.step}</span>
                        <div className="w-12 h-[2px] bg-gradient-to-r from-ice-400 to-cyan-400" />
                      </div>
                      <h3 className="heading-section text-2xl text-frost-900 dark:text-white mb-2">{item.title}</h3>
                      <p className="text-body text-frost-600 dark:text-frost-400">{item.description}</p>
                    </div>

                    <div className="relative lg:w-2/12 flex-shrink-0">
                      <div className="relative z-10 w-16 h-16 rounded-2xl bg-gradient-to-br from-ice-500 to-cyan-500 flex items-center justify-center shadow-lg lg:mx-auto">
                    ...
                    <div className={`w-full lg:w-5/12 ${item.side === 'left' ? 'lg:text-right lg:pr-8' : 'lg:pl-8'}`}>
                      <div className="aspect-square bg-gradient-to-br from-ice-50 to-ice-100 dark:from-ice-900/30 dark:to-ice-800/30 rounded-2xl flex items-center justify-center border border-ice-200/50 dark:border-ice-800/50">
                        <item.icon className="w-16 h-16 text-ice-300 dark:text-ice-700" aria-hidden="true" />
                      </div>
                    </div>
                  </motion.div>
                ))}
        ...
        {/* Stats Section */}
        <section className="py-16 bg-gradient-ice-dark relative overflow-hidden">
          <div className="absolute inset-0 bg-mesh-ice" aria-hidden="true" />
          <div className="container-custom relative">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="heading-brand text-4xl sm:text-5xl lg:text-6xl text-white mb-2">
                    {stat.value}
                  </div>
        ...
        <section id="depoimentos" className="section-padding bg-white dark:bg-frost-900 relative">
          <div className="absolute inset-0 bg-mesh-frost" aria-hidden="true" />
          <div className="container-custom relative">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {testimonials.map((testimonial, index) => (
                <motion.article
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                >
                  <Card variant="elevated" className="h-full p-6 card-ice-elevated">
                    <div className="flex items-center gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-5 h-5 fill-amber-400 text-amber-400" aria-hidden="true" />
                      ))}
                    </div>
                    <p className="text-body text-frost-700 dark:text-frost-300 mb-6 flex-1">"{testimonial.content}"</p>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-ice-400 to-cyan-400 flex items-center justify-center heading-brand text-white text-lg">
                        {testimonial.name.charAt(0)}
                      </div>
                      <div>
                        <p className="font-semibold text-frost-900 dark:text-white">{testimonial.name}</p>
                        <p className="text-sm text-frost-500 dark:text-frost-400">{testimonial.role} - {testimonial.company}</p>
                      </div>
                    </div>
                  </Card>
                </motion.article>
        ...
        {/* FAQ Section */}
        <section id="faq" className="section-padding bg-frost-50 dark:bg-frost-900/50 relative">
          <div className="absolute inset-0 bg-mesh-frost" aria-hidden="true" />
          <div className="container-custom max-w-3xl relative">
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <motion.details
                  ...
                  className="group card-ice p-6"
                >
                  <summary className="flex items-center justify-between cursor-pointer list-none font-semibold text-frost-900 dark:text-white text-lg">
                    {faq.question}
                    <ChevronRight className="w-5 h-5 text-frost-400 transition-transform duration-300 group-open:rotate-90" aria-hidden="true" />
                  </summary>
                  <div className="mt-4 pt-4 border-t border-ice-200/50 dark:border-ice-800/50 animate-in fade-in slide-down">
                    <p className="text-body text-frost-600 dark:text-frost-400">{faq.answer}</p>
                  </div>
                </motion.details>
              ))}
            </div>
            ...
            >
              <p className="text-body text-frost-600 dark:text-frost-400 mb-4">Não encontrou sua dúvida?</p>
              <Button variant="outline" size="lg" asChild>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                <div className="flex flex-col items-center gap-2 p-4">
                  <div className="w-12 h-12 rounded-xl ice-glass flex items-center justify-center">
                ...
                <div className="flex flex-col items-center gap-2 p-4">
                  ...
                  <p className="text-ice-200/80 text-sm text-center">(11) 99999-9999<br />contato@bestgelo.com.br</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        {/* Map Section */}
        <section className="py-16 bg-frost-50 dark:bg-frost-900/50" aria-label="Localização">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              <h3 className="heading-section text-2xl text-center mb-6">Nos Encontre no Mapa</h3>
              <div className="aspect-video rounded-2xl overflow-hidden shadow-[var(--shadow-glass-lg)] bg-frost-200 dark:bg-frost-800">
                <iframe
      ...
      {/* Footer */}
      <footer className="bg-frost-900 text-ice-100 relative">
        <div className="absolute inset-0 bg-mesh-ice opacity-50" aria-hidden="true" />
        <div className="container-custom py-16 relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="flex items-center gap-2 mb-6" aria-label="Best Gelo - Página inicial">
                ...
                <span className="heading-brand text-xl text-white">Best Gelo</span>
              </Link>
              ...
              <div className="flex gap-4">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-frost-800 flex items-center justify-center text-ice-300 hover:bg-accent/20 hover:text-white transition-colors" aria-label="Facebook">
                  <Facebook className="w-5 h-5" aria-hidden="true" />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-frost-800 flex items-center justify-center text-ice-300 hover:bg-accent/20 hover:text-white transition-colors" aria-label="Instagram">
            ...
            <address className="not-italic" aria-label="Informações de contato">
              ...
              <ul className="space-y-3 text-ice-200/70 text-body-sm">
                <li className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 mt-0.5 flex-shrink-0 text-ice-400" aria-hidden="true" />
                  <span>Rua Bras Cubas, 624 - Vila Bocaina<br />Mauá - SP, 09310-730</span>
                </li>
                <li className="flex items-center gap-3">
                  <Phone className="w-5 h-5 flex-shrink-0 text-ice-400" aria-hidden="true" />
                  <a href="tel:+5511999999999" className="hover:text-white transition-colors">(11) 99999-9999</a>
                </li>
                <li className="flex items-center gap-3">
                  <Mail className="w-5 h-5 flex-shrink-0 text-ice-400" aria-hidden="true" />
                  <a href="mailto:contato@bestgelo.com.br" className="hover:text-white transition-colors">contato@bestgelo.com.br</a>
                </li>
                <li className="flex items-center gap-3">
                  <MessageCircle className="w-5 h-5 flex-shrink-0 text-ice-400" aria-hidden="true" />
          ...
          {/* Bottom Bar */}
          <div className="border-t border-frost-800 pt-8 relative">
      ...
      <motion.aside
        ...
        className="fixed top-0 right-0 h-full w-full max-w-sm z-50 bg-white dark:bg-frost-900 shadow-[var(--shadow-glass-lg)] flex flex-col"
        aria-label="Carrinho de compras"
      >
        <div className="flex items-center justify-between p-4 border-b border-ice-200/50 dark:border-ice-800/50">
          <h3 className="heading-card text-frost-900 dark:text-white">Carrinho ({getTotalItems()})</h3>
        ...
        <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="space-y-4">
              {items.map((item) => (
                <div key={item.id} className="flex gap-3 p-2 bg-frost-50 dark:bg-frost-800/50 rounded-xl">
                  <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-ice-100 to-ice-200 dark:from-ice-900/30 dark:to-ice-800/30 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-primary dark:text-ice-400">{formatCurrency(item.price)} x {item.quantity}</p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => useCartStore.getState().removeItem(item.productId)} className="p-1 text-frost-400 hover:text-accent" aria-label="Remover item">
          ...
          {items.length > 0 && (
            <div className="mt-6 pt-6 border-t border-ice-200/50 dark:border-ice-800/50 space-y-3">
              ...
              <div className="flex justify-between text-heading-md font-bold text-frost-900 dark:text-white border-t border-ice-200/50 dark:border-ice-800/50 pt-3">
                <span>Total</span>
        ...
        {items.length > 0 && (
          <div className="p-4 border-t border-ice-200/50 dark:border-ice-800/50 space-y-3">
